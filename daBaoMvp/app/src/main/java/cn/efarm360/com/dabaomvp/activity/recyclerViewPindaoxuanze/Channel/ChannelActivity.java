...
import cn.efarm360.com.dabaomvp.activity.recyclerViewPindaoxuanze.ItemDragHelperCallback;
...
public class ChannelActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        helper.attachToRecyclerView(mRecy);   //设置自定义的callback

        final ChannelAdapter adapter = new ChannelAdapter(this, helper, items, otherItems);

        //设置源来获取适配器中每个条目所占用的跨度的数量。 setSpanSizeLookup()
        // * @param斯潘西兹elookup@link可用于查询跨行数 被每一项所占用
