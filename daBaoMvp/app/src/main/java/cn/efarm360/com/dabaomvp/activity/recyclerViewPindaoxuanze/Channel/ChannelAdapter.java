package cn.efarm360.com.dabaomvp.activity.recyclerViewPindaoxuanze.Channel;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
     ...
     *  构造器
     * @param context  上下文
     * @param helper   ItemTouchHelper
     * @param mMyChannelItems  集合
     * @param mOtherChannelItems   集合
     */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                ...
                holder.tvBtnEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!isEditMode) {
                            startEditMode((RecyclerView) parent);   //开启编辑模式 显示图片
                            holder.tvBtnEdit.setText(R.string.finish);
                        } else {
                            cancelEditMode((RecyclerView) parent);  //关闭编辑模式
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.item_my, parent, false);  //我的频道
